<html>
    ...
    <body>
        <form class="ulockd-login-form" action="../controller/donation_plan_controller.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" class="form-control"  name="txtDonationDiscription" id="txtDonationDiscription" placeholder="Donation Description">
            </div>

            <div class="form-group">
                <div class="form-control">
                    Donation Type
                    <select name="sltDonation_type_id">            
                        <?php
